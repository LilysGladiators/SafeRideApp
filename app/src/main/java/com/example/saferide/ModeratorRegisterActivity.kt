...
class ModeratorRegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firebaseAuthListener = FirebaseAuth.AuthStateListener { firebaseAuth ->
            ...
            if (user != null) {
                val intent = Intent(this@ModeratorRegisterActivity, ModeratorActivity::class.java)
            ...
            gAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this) { task ->
                    if (!task.isSuccessful) {
                        Toast.makeText(this@ModeratorRegisterActivity, "Sign up error", Toast.LENGTH_SHORT).show()
                    } else {
